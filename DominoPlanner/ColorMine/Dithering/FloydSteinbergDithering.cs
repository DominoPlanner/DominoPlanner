...
{
    unsafe class FloydSteinbergDithering : Dithering
    {
        ...
        public FloydSteinbergDithering(IColorSpaceComparison comparison, List<DominoColor> palette)
        {
            comp = comparison;
        ...
        private void DiffuseError(int x, int y, int r, int g, int b)
        {
            ...
            {
                SetPixel(x + 1, y, 
                        Scale((int)((double)(GetPixel(x + 1, y).R) + ((double)r * 7d / 16d))),
                        Scale((int)((double)(GetPixel(x + 1, y).G) + ((double)g * 7d / 16d))),
                        Scale((int)((double)(GetPixel(x + 1, y).B) + ((double)b * 7d / 16d))));
            }
            if (y + 1 < bitmap.Height && x != 0)
            {
                SetPixel(x - 1, y + 1, 
                        Scale((int)((double)(GetPixel(x - 1, y + 1).R) + ((double)r * 3d / 16d))),
                        Scale((int)((double)(GetPixel(x - 1, y + 1).G) + ((double)g * 3d / 16d))),
                        Scale((int)((double)(GetPixel(x - 1, y + 1).B) + ((double)b * 3d / 16d))));
            }
            if (y + 1 < bitmap.Height)
            {
                SetPixel(x, y + 1, 
                        Scale((int)((double)(GetPixel(x, y + 1).R) + ((double)r * 5d / 16d))),
                        Scale((int)((double)(GetPixel(x, y + 1).G) + ((double)g * 5d / 16d))),
                        Scale((int)((double)(GetPixel(x, y + 1).B) + ((double)b * 5d / 16d))));
            }
